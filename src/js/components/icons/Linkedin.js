...
var CLASS_ROOT = "linkdein-icon";

var Linkdein = React.createClass({
  ...
  render: function() {
    ...
    var logoTitleId = 'Linkedin-title'; //+ uuid.v1();

    return (
      <svg className={classes.join(' ')} width="150px" viewBox="0 0 291 79.45"
