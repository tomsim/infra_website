...
var CLASS_ROOT = "p4org-icon";

var P4org = React.createClass({
  ...
  render: function() {
    ...
    var logoTitleId = 'p4org-title';// + uuid.v1();

    return (
      <svg className={classes.join(' ')} fill="#fff"
        viewBox="0 0 258 216.7" width="100" version="1.1"
        role="img" aria-labelledby={logoTitleId}>
        <title id={logoTitleId}>{this.getGrommetIntlMessage(this.props.a11yTitle)}</title>
        <path fill="none" stroke="#000" strokeWidth="10" d="M170.3,77.3c0,22.8-18.5,41.3-41.3,41.3
